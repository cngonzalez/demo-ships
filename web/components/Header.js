...
export default function Header() {
  return (
    <header>
      <Popover className="relative bg-amber-100">
        <div className="flex justify-between items-center max-w-7xl mx-auto px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
          <div className="flex justify-start lg:w-0 lg:flex-1">
            <Link href="/">
              <a>
                <span className="sr-only">Workflow</span>
                <MapIcon className="w-8 md:w-12 h-auto text-amber-600" />
              </a>
            </Link>
          </div>
                ...
                <>
                  <Popover.Button
                    className={classNames(
                      ...
                      'group bg-transparent rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500'
                    )}
                  >
                    <span>Deals</span>
                    <ChevronDownIcon
                      ...
                      <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                        <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8 lg:grid-cols-2">
                          {solutions.map((item) => (
                            ...
                            >
                              <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-amber-600 text-white sm:h-12 sm:w-12">
                ...
                <div className="mt-6">
                  <nav className="grid grid-cols-1 gap-7">
                    {solutions.map((item) => (
                      ...
                      >
                        <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-amber-600 text-white">
                          <item.icon className="h-6 w-6" aria-hidden="true" />
                        </div>
